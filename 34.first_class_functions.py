...
print(search(friends, "Bob Smith", get_friend_name)) # for a recap of what this func does is get_friend_name will  be the finder func, the expected will be rolf smith, which goes into friends array .
