...
#cls is a abbreviation in class. The reason why we use cls in the return portion instead of book because later down the line it will help when dealing with inheritance.