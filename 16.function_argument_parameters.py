...
say_hello(name="Bob", surname="Smith")  # Obvious that this is someone's name
...
# divide(dividend=15, 0)  # Not OK, named arguments must go after positional arguments. Keyword arguments go later in code (refer to lines 47 and 48)
