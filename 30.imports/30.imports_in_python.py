# from mymodule import divide #how to access a specific thing from another file. 

# import mymodule # this is how to bring over the whole file and call a specefic function within it.
# mymodule.divide
