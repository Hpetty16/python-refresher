...
# This because there is only two items in the abroad set vs three in the friends set.
...
# friends = ...
# If we have 1 local friend and 2 abroad friends, we could calculate the total friends by using `.union` Union basically unites two sets and gives you the total of both.
